...
<head>
    ...
    <link rel="stylesheet" href="http://127.0.0.1:8000/dist/css/skins/skin-blue.min.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>the</b>Babies</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        powered by <strong>&copy;the babies</strong>
    </footer>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     user experience. -->
<!-- my js -->
<script src="http://127.0.0.1:8000/js/jquery/jquery-3.1.1.min.js"></script>
<script src="http://127.0.0.1:8000/css/bootstrap-4.0.0-alpha.6-dist/js/bootstrap.min.js"></script>
<script src="http://127.0.0.1:8000/js/fileupload.js"></script>
